...
from payments import serializers as orderSz
from payments .serializers import CartSerializer, CartItemSerializer, AddCartItemSerializer, UpdateCartItemSerializer
...
class OrderViewset(ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if self.request.user.is_staff:
            return Purchase.objects.prefetch_related('items__course').all()
        return Purchase.objects.prefetch_related('items__course').filter(user=self.request.user)